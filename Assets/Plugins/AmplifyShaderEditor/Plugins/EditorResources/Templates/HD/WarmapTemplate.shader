Shader /*ase_name*/ "Hidden/HDRP/WarmapTemplate" /*end*/
{
	Properties
	{
		/*ase_props*/
		...
		SubShader
		{
			...
			*/
			...
			ENDHLSL
				...
				#include "Assets/Scripts/Game/Editor/CodexWarmapEditor/Warmap.cginc"
				...
				float _TessMaxDisp;
				#endif
#include "Assets/AmplifyShaderEditor/Plugins/EditorResources/Templates/HD/WarmapProperties.cginc"
				CBUFFER_END
