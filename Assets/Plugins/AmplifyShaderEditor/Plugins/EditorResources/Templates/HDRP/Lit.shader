	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:  Instanced Terrain Normals:Force Vertex,Force Pixel,Material Option:Force Pixel
				...
				Force Pixel?Category=Terrain:SetDefine:DepthOnly:_INSTANCEDTERRAINNORMALS_PIXEL
			...
			Option:Receive Decals,InvertActionOnDeselection:Force Off,Material Toggle:Material Toggle
				Force Off:SetDefine:pragma multi_compile_local_fragment _DISABLE_DECALS
				Force Off:SetShaderProperty:_SupportDecals,//[HideInInspector][ToggleUI] _SupportDecals("Support Decals", Float) = 1.0
				Material Toggle:SetDefine:pragma shader_feature_local_fragment _ _DISABLE_DECALS
