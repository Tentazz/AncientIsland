...
Shader "Star shader"
{
	Properties
	{
		...
		_Debugtimeofday( "Debug time of day", Range( 0, 1 ) ) = 0
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				surfaceDescription.Alpha = SampleGradient( gradient11, lerpResult14 ).r;
